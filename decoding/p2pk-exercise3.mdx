...
<div className="max-w-3xl mx-auto rounded-md m-4 mr-3 ml-3 p-4 bg-[#1e1e1e]">
  ...
  pythonHeight="39rem"
  pythonCode={`from decoder import decode_p2pk_scriptpubkey
...
print("P2PK ScriptPubKey Decoder")
print("-------------------------")

for i, case in enumerate(test_cases, 1):
    print(f"\\nTest Case {i} ({case['type']} Public Key):")
    print("Input:   ", case['input'])
    print("Expected:", case['output'])
    try:
        result = decode_p2pk_scriptpubkey(case['input'])
        print("Result:  ", result)
        print("Status:  ", "PASSED" if result == case['output'] else "FAILED")
...
def decode_p2pk_scriptpubkey(hex_script):
    # TODO: Implement the P2PK scriptPubKey decoding
    # The function should take a hex string as input and return the decoded script in ASM format
    # Example: "02e9a095a6a5790bc82feade07ee6fc77b05bc4de7f3790c36d2ecc886d9ec0ac0 OP_CHECKSIG"
    pass`
  }}
/>
