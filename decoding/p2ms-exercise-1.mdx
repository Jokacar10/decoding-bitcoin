...
export default P2MSGame;`,
  ...
  pythonHeight="20rem"
  pythonCode={`from p2ms_exercise import construct_p2ms_p2sh_scriptpubkey

# Test data
pubkey1 = "02632178d046673c9729d828cfee388e121f497707f810c131e0d3fc0fe0bd66d6"
pubkey2 = "03a0951ec7d3a9da9de171617026442fcd30f34d66100fab539853b43f508787d4"
expected_result = "a9148ce5408cfeaddb7ccb2545ded41ef4781094548487"

# Test the function
result = construct_p2ms_p2sh_scriptpubkey(pubkey1, pubkey2)
...
print(f"Correct:  {result == expected_result}")`}
  pythonModules={{
    "p2ms_exercise.py": `import hashlib

def construct_p2ms_p2sh_scriptpubkey(pubkey1: str, pubkey2: str) -> str:
    # TODO: Implement the P2MS-P2SH scriptPubKey construction
    # The function should take two public keys as input and return the P2MS-P2SH scriptPubKey in hex format
    # Steps:
    ...
    # 4. Create the P2SH script: OP_HASH160 <redeemScriptHash> OP_EQUAL
